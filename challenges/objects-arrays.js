...
const dino1 = new Dino ('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceous')

// stegosaurus, herbivorous, 2000kg, 9m, 'Late Jurassic'
const dino2 = new Dino ('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic') 
// 
const dino3 = new Dino ('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceous') 
...
const universities = graduates.map( (it) => it.university ).sort();
...
const contactInfo = graduates.map( (it) => `${it.first_name} ${it.email}`)
...
*/
const populationTotal = zooAnimals.map( (it) => it.population ).reduce( (accum, cur) => accum + cur, 0)
